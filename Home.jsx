...
const slides = [
  {
    ...
    description: "<h3>Delivering Top-Notch <span style='color: red;'><br/>App Development Services</span></h3><p>Transform ideas into user-friendly apps, staying competitive in the market.</p>",
    image: require("../assets/AppDev.png"),
  },
  {
    title: "Web Development",
    description: "<h3>Delivering Top-Notch <span style='color: red;'><br/>Web Development Services</span></h3><p>Boost online visibility with sleek designs and powerful websites.</p>",
    image: require("../assets/Web.png"),
  },
  {
    title: "Game Development",
    description: "<h3>Revolutioning <span style='color: red;'>Game <br/>Development Services</span></h3><p>Create engaging games for various platforms with our tech <br/>and creativity.</p>",
    image: require("../assets/Game (1).png"),
  },
  {
    title: "Design",
    description: "<h3>All your <span style='color: red;'>Graphic/<br/>Game Designing </span>At one Place!</h3><p>Craft captivating visuals and UIs for immersive experiences.</p>",
    image: require("../assets/Design.png"),
  },
  {
    title: "Blockchain",
    description: "<h3>Your security with <span style='color: red;'><br/>BlockChain Development<br/> Services</span></h3><p>Embrace the future with improved security and efficiency <br/> through  smart contracts.</p>",
...
function Home() {
  ...
  const cardsData = [
    ...
    { img: Css, title: 'CSS', description: 'Style sheet language for\n web development' },
  ];
  // How we work slider 
      ...
      <div className="slide-container">
        <div className="header-row">
          <div className="col-lg-9">
            ...
            <div class="slidesDev-title d-flex align-items-center ">
...
>
  ...
  <span>Book A Demo</span>
            ...
            {/* <div className="col-lg-4 d-flex justify-content-start justify-content-lg-end">
              <button
                type="button"
                className="cta_btn btn-primary wow fadeInUpSlide"
                data-wow-duration="1s"
                data-wow-delay="0.4s"
                data-toggle="modal"
                data-target="#front_get_started"
                style={{
                  visibility: 'visible',
                  animationDuration: '1s',
                  animationDelay: '0.4s',
              ...
              >
                <em>
                  <img
                    src="https://www.chicmic.in/wp-content/themes/chicmic/img/android/phone.png"
                    alt=""
                    width="300"
                    className="img-fluid"
                  />
      ...
      <div className="services_blocks_row">
        <div className="service_column">
          <div className="wow fadeInUpSlide" data-wow-duration="1s" data-wow-delay="0.4s">
            <i>
              <img src={Java} alt="Mobile Development" />
        ...
        <div className="service_column">
          <div className="wow fadeInUpSlide" data-wow-duration="1s" data-wow-delay="0.4s">
            <i>
              <img src={Blockchain} alt="Blockchain Development" />
 ...
 <i>
        ...
        <div className="service_column">
            ...
            <i>
              <img src={Meta} alt="Metaverse Development" />
    ...
    <div className="field-row1">
            <div className="col-lg-12 col-sm-12">
              ...
              >
                ...
                <h2 className="h4 mb-0">Industries We Serve</h2>
              </div>
            </div>
          </div>
   ...
   <div className="footer-container">
      <div className="footer-content">
        ...
        <div className="footer-section contact">
          ...
          <p><FontAwesomeIcon icon={faEnvelopeSquare} />  contact@airai.games</p>
